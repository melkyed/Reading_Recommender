...
# load functions
source('functions/colla_filtering.R') 
source('functions/similarity_alg.R') 
...
books <- fread('sampled_data/sampled_books.csv')
ratings <- fread('sampled_data/sampled_ratings.csv')
#
